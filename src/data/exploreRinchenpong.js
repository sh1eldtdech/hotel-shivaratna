...
export const NEARBY_PLACES = [
  {
    id: 1,
    name: "Ngagyur Rinchen Chholing Monastery",
    description: "Traditional Himalayan architecture and colorful prayer flags just opposite the hotel.",
    image: Ngagyur,
    distance: "100 m",
    category: "Spiritual"
  },
  {
    ...
    description: "Green park dedicated to Nobel Laureate Rabindranath Tagore opposite the hotel.",
    image: Rabindranath,
    distance: "50 m",
    category: "Nature"
  },
  {
    ...
    description: "Historic 1730 sanctuary housing a rare meditative Ati Buddha statue.",
    image: RinchenpongMonastery,
    distance: "1.8 km",
    category: "Spiritual"
  },
  {
    id: 4,
    name: "Poison Lake (Bikh Pokhri)",
    description: "Mysterious natural forest lake wrapped in ancient military defense legends.",
    image: PoisonLake,
    distance: "2 km",
    category: "Nature"
  },
  {
    id: 5,
    name: "Dak Bungalow",
    description: "Heritage bungalow viewpoint offering old-world charm and mountain panoramas.",
    image: DakBungalow,
    distance: "1 km",
    category: "Viewpoints"
  },
  ...
  },
  {
    id: 8,
    name: "Sribadam Waterfall",
    description: "Lush pine forests framing a majestic flowing mountain cascade.",
    image: SribadamWaterfall,
    distance: "12 km",
    category: "Nature"
  },
  {
    id: 9,
    name: "Bombhir Natural Mineral Spring",
    description: "Flowing mineral-rich mountain water, famous as a natural auto-wash stop.",
    image: Bombhir,
    distance: "18 km",
    category: "Nature"
  },
  {
    id: 10,
    name: "Chaayatal Lake",
    description: "Scenic alpine lake linked to historical tales of the local Subba King.",
    image: ChaayatalLake,
    distance: "30 km",
    category: "Nature"
  },
  {
    id: 11,
    name: "Bermiok Shiva Cave",
    description: "Sacred mountain cave dedicated to Lord Shiva in peaceful forest trails.",
    image: BermiokShiva,
    distance: "30 km",
    category: "Spiritual"
  },
  {
    id: 12,
    name: "Srijunga Statue Complex",
    description: "36-foot bronze statue honoring the historical Limbu script scholar.",
    image: ChaayatalLake,
    distance: "30 km",
    category: "Cultural"
  },
