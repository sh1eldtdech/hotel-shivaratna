    ...
    <div>
      ...
      <section id="about-intro" className="pt-28 pb-20 bg-luxury-cream">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          {/* Amenities Strip G�� Centered Flex wrap layout to eliminate empty grid space */}
          <motion.div
            {...fadeUp(0)}
            className="mt-24"
          >
      ...
      {/* Quote Banner G�� "Every sunrise bringsGǪ" */}
      <div
      ...
      {/* Accommodation G�� Rectangle shape with hover video effect */}
              ...
              >
                ...
                <div className="w-full aspect-[4/3] relative overflow-hidden border border-gold/15 shadow-premium rounded-sm">
                  ...
                  <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-neutral-950/85 backdrop-blur-md text-white font-sans text-xs px-4 py-2 border border-gold/30 z-20 whitespace-nowrap tracking-wider transition-opacity duration-500 group-hover:opacity-0">
                    G�{room.price.toLocaleString('en-IN')} <span className="text-neutral-400 font-light text-[9.5px]">/ Night</span>
                  </div>
                  {/* Hover overlay G�� slides up like a video reveal */}
                  <div className="absolute inset-0 bg-neutral-950/80 flex flex-col items-center justify-center translate-y-full group-hover:translate-y-0 transition-transform duration-700 ease-[cubic-bezier(0.4,0,0.2,1)] z-30">
                    ...
                    <span className="text-gold text-4xl md:text-5xl font-serif font-normal tracking-wide mb-4">G�{room.price.toLocaleString('en-IN')}</span>
      ...
      {/* Our Facilities G�� All 12 amenities with logo + text */}
      ...
      {/* Feature Section 1 G�� Organic Farm Fresh Cuisine */}
          ...
          >
            ...
            >
              ...
              <motion.p
                ...
                className="text-neutral-700 text-sm md:text-base font-sans font-light leading-relaxed text-justify"
              >
                Our multi-cuisine restaurant serves authentic Sikkimese dishes, Indian comfort food, and continental favourites G�� all prepared with love by our kitchen team. Pair your meal with refreshing drinks or explore our fully stocked bar for the perfect mountain dining experience.
              </motion.p>
      ...
      {/* Feature Section 2 G�� Workstation & Lounge */}
      <section className="py-24 bg-white border-t border-neutral-100">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <motion.div
            className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center"
          ...
          >
            ...
            >
              ...
              <motion.p
                ...
                className="text-neutral-700 text-sm md:text-base font-sans font-light leading-relaxed text-justify"
              >
                Whether you're a remote worker, digital nomad, or a business traveller on the move, Hotel Shivaratna's dedicated workstation and lounge provides everything you need to stay productive G�� high-speed Wi-Fi, comfortable seating, and the inspiring backdrop of the Himalayas.
              </motion.p>
              <motion.p
                variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}
                className="text-neutral-700 text-sm md:text-base font-sans font-light leading-relaxed text-justify"
              >
                When the workday is done, transition seamlessly to relaxation mode in our comfortable lounge G�� a serene space to unwind, connect with fellow travellers, or simply soak in the peaceful mountain atmosphere.
              </motion.p>
              <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}>
                <Link
                  to="/rooms"
                  ...
                  {isQuoteTile ? (
                    <div className="w-full h-full bg-neutral-950 text-white flex flex-col items-center justify-center px-6 text-center">
                      ...
                      <p className="font-serif text-lg md:text-2xl leading-tight tracking-wide max-w-[15ch]">
                        GǣWarm stays, mountain views, and moments worth returning for.Gǥ
                      </p>
                    </div>
                  ) : (
                    <>
